...
class PokemonsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('default_shiny_sprite_url')
            ->maxLength('default_shiny_sprite_url', 255)
            ->requirePresence('default_shiny_sprite_url', 'create')
            ->allowEmptyString('default_shiny_sprite_url', 'true');
    ...
    public function formatDataForSave($pokeApiData)
    {
        ...
        return [
            ...
            'default_back_sprite_url' => $pokeApiData['sprites']['front_default'],
            'default_shiny_sprite_url' => $pokeApiData['sprites']['front_default'],
